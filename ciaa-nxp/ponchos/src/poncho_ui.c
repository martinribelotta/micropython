...
#ifdef CHIP_LPC5410X
#define SCU_MODE_FUNC0 IOCON_FUNC0
#define SCU_MODE_FUNC1 IOCON_FUNC1
#define SCU_MODE_FUNC2 IOCON_FUNC2
#define SCU_MODE_FUNC3 IOCON_FUNC3
#define SCU_MODE_FUNC4 IOCON_FUNC4
#define SCU_MODE_FUNC5 IOCON_FUNC5
#define SCU_MODE_FUNC6 IOCON_FUNC6
#define SCU_MODE_FUNC7 IOCON_FUNC7

#define SCU_MODE_INACT     IOCON_MODE_INACT
#define SCU_MODE_INBUFF_EN IOCON_DIGITAL_EN
#define SCU_MODE_ZIF_DIS   0

#define Chip_SCU_PinMuxSet(port, pin, conf) Chip_IOCON_PinMuxSet(LPC_IOCON, port, pin, conf)
#endif
...
static LCDPinInfo lcdPinInfo[]={
        {4,4,2,4,SCU_MODE_FUNC0},
		{4,5,2,5,SCU_MODE_FUNC0},
		{4,6,2,6,SCU_MODE_FUNC0},
		{4,10,5,14,SCU_MODE_FUNC4},
		{4,8,5,12,SCU_MODE_FUNC4},
		{4,9,5,13,SCU_MODE_FUNC4}
};
