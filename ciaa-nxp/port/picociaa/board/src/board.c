...
void Board_UART_Init(LPC_USART_T *pUART)
{
	...
	Chip_UART_ConfigData(pUART, UART_CFG_DATALEN_8 | UART_CFG_STOPLEN_1 | UART_CFG_PARITY_NONE);
	Chip_UART_Enable(pUART);
...
void Board_UART_tick_ms()
{
	// TODO
}
void Board_LED_PWM_tick_ms()
{
	// TODO
}
